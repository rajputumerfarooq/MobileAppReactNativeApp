...
import MassengerStack from './Stacks/Massenger/MassengerStack';
...
export default function index() {
  ...
  return (
    ...
    >
      ...
      <Tab.Screen
        name={NavigationStrings.COACH_NOTIFICATION_STACK}
      ...
      <Tab.Screen
        name={NavigationStrings.COACH_MASSENGER_STACK}
        component={MassengerStack}
        options={{
        
          tabBarLabel: 'Massenger',
          tabBarColor: 'transparent',
          tabBarIcon: ({ color }) => (
      ...
      <Tab.Screen
        name={NavigationStrings.COACH_PROFILE_STACK}
