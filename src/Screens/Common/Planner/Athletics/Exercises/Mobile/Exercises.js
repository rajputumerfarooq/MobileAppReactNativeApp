...
const Exercises = () => {
  ...
  const addExercises = async () => {
    ...
    console.log(FinalPlannerObject);
     ...
     var res=  await  createAppointmentSchedular(requestBody.loggedUser,FinalPlannerObject);
      ...
      <View style={styles.boxContainer}>
        ...
        >
          ...
          <TouchableOpacity
            onPress={() => {
              navigation.navigate(
                NavigationStrings.ATHELTIC_EXERCISE_DETAIL,
                { obj: item }
              );
            }}
          >
 ...
 const renderSelectedExercises = ({ item }) => (
  ...
  <FontAwesome name="lock" color="#fff" size={20} />
      ...
      <View style={{ flex: 0.85, width: "100%" , padding:2}}>
        <FlatList
          data={fetchedData}
